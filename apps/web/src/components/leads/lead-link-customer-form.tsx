  ...
  if (customers.length === 0) {
    return (
      <EmptyState
        ...
        description="Create a customer first, then return here to link this request."
      >
  ...
  return (
    <form action={formAction} className="space-y-4">
      ...
      <p className="text-xs leading-relaxed text-foreground-muted">
        If this request has a service address, it is added to the customer when it is not already on
        file. Duplicate addresses are skipped.
      </p>
