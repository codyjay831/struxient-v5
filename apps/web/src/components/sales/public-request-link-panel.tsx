...
import { CopyPublicRequestUrlButton } from "@/components/sales/copy-public-request-url-button";
...
export function PublicRequestLinkPanel({
  ...
  return (
    <WorkspacePanel padding="compact" className={className}>
      ...
      <p className="mt-3">
        <Link href="/sales/public-request-settings" className={handoffMutedLinkClass}>
