  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-[minmax(220px,280px)_minmax(0,1fr)_minmax(220px,300px)] lg:gap-8">
        <WorkstationColumn
          title="Critical"
          description="Things that can break today."
          className="order-1"
        >
          <CriticalGroupsList
        ...
        <WorkstationColumn
          title="Today"
          description="Schedule, due work, and follow-ups."
          className="order-2 lg:order-3 lg:border-l lg:border-border lg:pl-6"
        >
          <TodayAgendaList
        ...
        <WorkstationColumn
          title="Next actions"
          description="Ranked work you can act on from here."
          className="order-3 lg:order-2 lg:border-l lg:border-border lg:pl-6"
        >
          <NextActionsList
      ...
      <WeekStrip days={presentation.overviewWeekPreview} />
    </div>
  );
}
