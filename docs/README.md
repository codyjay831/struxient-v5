# Documentation — Struxient v5

> **Scope:** This folder documents the **`Struxient_v5`** repository only — **Struxient version 5**. It is not the source of truth for other Struxient versions, forks, or legacy repos; if something conflicts with an older version, **v5 wins here**.

Project documentation lives here. Canon (authoritative setting and story facts) is under [canon](./canon/).
...
Add guides, ADRs, or onboarding notes alongside canon as the project grows.
